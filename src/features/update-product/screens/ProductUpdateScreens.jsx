...
const AddProduct = () => {
  ...
  const dataOption = MapOptions(productType && productType);
  // bộ sưu tập
  let ArrayGalleris =
    productDetail &&
            ...
            userLogin?.id === productDetail?.teacher_id ? (
              <Formik
                ...
                onSubmit={async (values, { rest }) => {
                  ...
                  newObjProduct.status = values.description;
                  newObjProduct.teacher_id = values.teacher;
